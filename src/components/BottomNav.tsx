  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 pb-safe z-50">
      <div className="flex justify-around items-center h-16">
        ...
        <Link 
          href="/dashboard" // TODO: Create dedicated /apiaries list page? For now dashboard list is fine
        ...
        <Link 
          href="/hives" // Need to create this page or link to somewhere relevant
