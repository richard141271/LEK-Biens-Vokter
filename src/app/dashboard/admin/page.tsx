      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <section className="mb-12">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Brukere, butikk og teknisk datahåndtering.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link href="/dashboard/admin/grunneier" className="group">
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:border-indigo-500 hover:shadow-md transition-all h-full">
                <div className="flex items-center justify-between mb-4">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">Grunneierportal</h3>
                <p className="text-sm text-gray-500 mb-4">
                  Se og avslutt avtaler. Kontrollér tilgang slik at ingenting deles på tvers.
                </p>
                <div className="flex items-center gap-2 text-xs font-medium text-indigo-700 bg-indigo-50 px-3 py-2 rounded-lg">
                  <ShieldCheck className="w-4 h-4" />
                  <span>Tilgangskontroll</span>
                </div>
              </div>
            </Link>
            ...
            <Link href="/dashboard/admin/email" className="group">
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:border-indigo-500 hover:shadow-md transition-all h-full">
                <div className="flex items-center justify-between mb-4">
                  <div className="p-3 bg-indigo-50 text-indigo-600 rounded-lg group-hover:bg-indigo-600 group-hover:text-white transition-colors">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">E-postadministrasjon</h3>
                <p className="text-sm text-gray-500 mb-4">
                  Administrer e-postkontoer, aliaser og tilganger for alle brukere.
                </p>
                <div className="flex items-center gap-2 text-xs font-medium text-gray-400 bg-gray-50 px-3 py-2 rounded-lg">
                  <Settings className="w-4 h-4" />
                  <span>Administrasjon</span>
            ...
            <Link href="/dashboard/admin/franchise" className="group">
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:border-yellow-500 hover:shadow-md transition-all h-full">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">Franchise-portal</h3>
                <p className="text-sm text-gray-500 mb-4">
                  Administrer franchise-enheter, avtaler, opplæring og rapportering.
                </p>
                <div className="flex items-center gap-2 text-xs font-medium text-gray-400 bg-gray-50 px-3 py-2 rounded-lg">
