...
import { Eye, EyeOff, ShieldCheck, Search, Map } from "lucide-react";
              ...
              <form onSubmit={handleLogin} className="space-y-3">
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="Passord"
                    className="w-full px-4 py-2 pr-12 bg-slate-700/50 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:ring-2 focus:ring-green-400 outline-none"
                    required
                  />
                  <button
                    type="button"
